<?php
	...
	$query="SELECT id_alumno, nombre, matricula, passwd, email, telefono FROM alumno  where matricula = $matricula";
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">Modificar Alumno</li>
			</ol>
		</div><!--/.row-->
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<div class="col-md-6">
							<form role="form" action="mod_alumno.php?matricula=<?php echo $row['matricula'];?>" enctype="multipart/form-data" method="POST" name="modificar_alumno">
								...
								<div class="form-group">
									...
									<input class="form-control" placeholder="Matricula" name="matricula" value="<?php echo $row['matricula'];?>">
								</div>
								...
								<a href="mod_alumno.php?matricula=<?php echo $row['matricula'];?>"><button type="submit" class="btn btn-primary">Enviar</a></button>
								<a href="formalum.php"><button type="submit" class="btn btn-danger">Cancelar</button></a>
							</div>
						</form>
					</div>
				</div>
